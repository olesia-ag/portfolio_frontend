	...
	return (
		<div className={classes.AboutMe}>
			<p>
				...
				<br className={classes.brMajor} /> 15 years, one immigration, one degree
				in art history and a career in hospitality later I decided to take a
				leap of faith and go back to what made me happy long time ago - that is,
				sitting in front of the monitor and thinking 'how to make this work'
